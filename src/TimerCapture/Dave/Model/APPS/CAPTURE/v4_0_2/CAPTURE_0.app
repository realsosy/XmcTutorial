...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CAPTURE" URI="http://resources/4.0.2/app/CAPTURE/0" description="Perform signal analysis to find out the duty cycle and the period of an unknown input signal." mode="NOTSHARABLE" version="4.0.2" minDaveVersion="4.2.4" instanceLabel="dhCAPTURE_ONTIME" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="capture event" URI="http://resources/4.0.2/app/CAPTURE/0/vs_ccu4_cc4_event0" hwSignal="e0as" hwResource="//@hwResources.0"/>
  <virtualSignals name="capture event" URI="http://resources/4.0.2/app/CAPTURE/0/vs_ccu8_cc8_event0" hwSignal="e0as" hwResource="//@hwResources.1"/>
  <virtualSignals name="capture_interrupt" URI="http://resources/4.0.2/app/CAPTURE/0/vs_interrupt_capture" hwSignal="signal_in" hwResource="//@hwResources.3"/>
  ...
  <requiredApps URI="http://resources/4.0.2/app/CAPTURE/0/appres_cpu_ctrl" requiredAppName="CPU_CTRL_XMC4" requiringMode="SHARABLE">
  ...
  <hwResources name="Capture Input Pin" URI="http://resources/4.0.2/app/CAPTURE/0/hwres_port_pad_capture_in" resourceGroupUri="resources/0.1.40/port/p/1/pad/5" mResGrpUri="port/p/*/pad/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/Port1/Port1_1.dd#//@provided.29"/>
  </hwResources>
  <hwResources name="Capture Event Node" URI="http://resources/4.0.2/app/CAPTURE/0/hwres_cpu_nvic_interrupt_event_0" resourceGroupUri="peripheral/cpu/0/nvic/interrupt/*" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">

...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CAPTURE" URI="http://resources/4.0.2/app/CAPTURE/0" description="Perform signal analysis to find out the duty cycle and the period of an unknown input signal." mode="NOTSHARABLE" version="4.0.2" minDaveVersion="4.2.4" instanceLabel="dhCAPTURE_0" appLabel="" containingProxySignal="true">

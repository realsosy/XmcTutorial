...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="SPI_SLAVE" URI="http://resources/4.0.8/app/SPI_SLAVE/0" description="Configures a USIC channel to implement SPI slave functionality" mode="NOTSHARABLE" version="4.0.8" minDaveVersion="4.1.2" instanceLabel="dhSPI_SLAVE_0" appLabel="" containingProxySignal="true">
  ...
  <hwResources name="MOSI pin" URI="http://resources/4.0.8/app/SPI_SLAVE/0/__pin_hwres_port_pad_spi_mosi_0" resourceGroupUri="devicepackage/0/98" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.15"/>
  </hwResources>
  <hwResources name="MISO pin" URI="http://resources/4.0.8/app/SPI_SLAVE/0/__pin_hwres_port_pad_spi_miso_mosi_1" resourceGroupUri="devicepackage/0/97" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <hwResources name="SCLK pin" URI="http://resources/4.0.8/app/SPI_SLAVE/0/__pin_hwres_port_pad_spi_sclk" resourceGroupUri="devicepackage/0/95" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.0"/>
  </hwResources>
  <hwResources name="Slave select pin" URI="http://resources/4.0.8/app/SPI_SLAVE/0/__pin_hwres_port_pad_spi_sel" resourceGroupUri="devicepackage/0/96" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
